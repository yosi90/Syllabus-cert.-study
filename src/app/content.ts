...
export const uiCopy = {
  en: {
    ...
    readQuestion: "Read question and options",
    readExplanation: "Read answer explanation",
  ...
  es: {
    ...
    readQuestion: "Leer pregunta y opciones",
    readExplanation: "Leer explicación de la respuesta",
