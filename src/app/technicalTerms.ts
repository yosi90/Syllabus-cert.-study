...
export const technicalTerms: TechnicalTerm[] = [
  ...
  { term: "performance efficiency testing", translation: "pruebas de eficiencia del rendimiento", forms: [{ source: "pruebas de eficiencia del rendimiento" }, { source: "prueba de eficiencia del rendimiento" }, { source: "pruebas de eficiencia del desempeño" }, { source: "prueba de eficiencia del desempeño" }] },
